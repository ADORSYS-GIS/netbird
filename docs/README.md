...
- [**Operations Strategy Index**](operations-book/README.md)
  - [☸️ **Helm Stack Strategy**](operations-book/helm-stack/README.md)
  - [🐳 **Ansible Stack Strategy**](operations-book/ansible-stack/README.md)
  - [🛡️ **Security & Hardening**](operations-book/security-hardening.md)

---

## 📕 Runbooks (The Action)
Tactical tasks for deployment, upgrades, failover, and incident response.
- [**Global Runbook Index**](runbooks/README.md)
  - [☸️ **Helm Stack Runbooks**](runbooks/helm-stack/README.md)
