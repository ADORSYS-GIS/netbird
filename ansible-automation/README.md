...
![Directory Structure](../docs/img/directory_structure.png)
...
netbird_auth_authority: "https://your.keycloak.domain/realms/your_netbird_realm"
```

**IMPORTANT**:

Replace `YOUR_MANAGEMENT_SECRET`, `YOUR_SIGNAL_SECRET`, `YOUR_TURN_SECRET`, `YOUR_JWT_SECRET`, and `YOUR_POSTGRES_PASSWORD` with strong, randomly generated secrets.
